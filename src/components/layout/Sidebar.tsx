  ...
  return (
    <aside className="w-60 min-h-screen bg-slate-900 text-white flex flex-col">
      <div className="px-6 py-5 border-b border-slate-700">
        <h1 className="text-lg font-bold text-white">병원 블로그 생성기</h1>
        <p className="text-xs text-slate-400 mt-1">{userName || '사용자'}</p>
        {userRole === 'admin' && (
          <span className="inline-block mt-1 px-2 py-0.5 text-xs bg-blue-600 rounded-full">관리자</span>
        )}
      </div>
